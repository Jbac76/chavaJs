  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      ...
      <main className="flex-1 p-8">
        {status && (
          <div className="mb-6 rounded-md border border-emerald-300 bg-emerald-50 px-4 py-2 text-sm text-emerald-800 dark:border-emerald-700 dark:bg-emerald-950 dark:text-emerald-200">
            {status}
          </div>
        )}
        {children}
