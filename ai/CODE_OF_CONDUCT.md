...
pull requests, discussions, Discord if applicable), and also applies when an
individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainers at **[CONDUCT CONTACT EMAIL HERE]**. All
...
other unprofessional behavior. *Consequence:* A private, written warning,
...
continued behavior, including no interaction with those involved for a
specified period.
...
behavior, harassment, or aggression toward an individual. *Consequence:* A
